...
def main():
    ...
    parser.add_argument("--ip", type=str, default="0.0.0.0", help="IP address to bind to") # Cambiado a 0.0.0.0 por defecto
    ...
    port = int(os.environ.get("PORT", args.port)) # Lee PORT de env var, si no usa el puerto de args (7788 por defecto)
